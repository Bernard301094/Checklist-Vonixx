...
import {
  ...
  FileText, ShieldCheck, Pencil, ImagePlus, Loader2, ChevronLeft, Save,
} from 'lucide-react';
...
/* ─── Day Group ─────────────────────────────────────────────── */
function DayGroup({ dateKey, occs, onSelect, isToday }: { dateKey: string; occs: OccurrenceData[]; onSelect: (o: OccurrenceData) => void; isToday: boolean }) {
